...
TotalData %>%
  ...
  theme_classic() +
  labs(
    title = "Total Number of Seagrass Publications Over Time",
    subtitle = "Seagrass research categories include iomass, production, and structure",
    x = "Publication Year", y = "Total Number of Publications",
    linetype = "Publication Type", color = "Publication Type"
  ) +
