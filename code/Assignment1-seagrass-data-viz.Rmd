...
```{r}
Biomass <- seagrass2 %>% group_by(Seagr.biom.above.dm..g.m..2.,
                                  Seagr.biom.below.dm..g.m..2.,
                                  Seagr.biom.tot.dm..g.m..2.) %>%
  summarise(Pubyear)

Biomass1 <- seagrass2 %>% group_by(Pubyear) %>%
  tally(across(c(Seagr.biom.above.dm..g.m..2.,Seagr.biom.below.dm..g.m..2.,Seagr.biom.tot.dm..g.m..2.)))
...
Create new dataset with all the total values
...
>>>>>>> 71a7bf84b92e2800d90d02fccb581f6f7ed666e8
