...
```
show.legend = FALSE  tells R not to include the legend on the plot.
...
Run a density plot for the line chart (other times we can just use geom_line but this is not useful for this chart), run a boxplot, histogram and a barchart.
